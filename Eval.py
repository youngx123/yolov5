...
class yolov5():
    ...
    def detect(self, srcimg):
        ...
        for i in range(self.nl):
            ...
            outs[i] = outs[i].reshape(bs, self.na, self.no, ny, nx).transpose(0, 1, 3, 4, 2)   # #[batchsize, 3, grid_size1~3, grid_size1~3, 4coord +1object_score + classNum]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--imgpath", type=str, default='./zidane.jpg', help="image path")
    parser.add_argument('--net_type', default='./yolo_onnx/yolov5x',
    ...
    yolonet = yolov5(args.net_type, confThreshold=args.confThreshold,
    ...
    outDir = "./test_result"
    outFileName = os.path.join(outDir, "Out_" + os.path.basename(args.imgpath))
    cv2.imwrite(outFileName, srcimg)
